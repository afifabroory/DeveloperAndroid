...
import com.example.hellocompatchallange.databinding.ActivityMainBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mainBinding.colorButton.setOnClickListener(v -> {
            ...
            if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.M)
                colorRes = getResources().getColor(resourceName, this.getTheme());
            else
                colorRes = ContextCompat.getColor(this, resourceName);
