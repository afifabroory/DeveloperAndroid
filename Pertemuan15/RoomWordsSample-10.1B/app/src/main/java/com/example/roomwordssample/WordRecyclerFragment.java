...
public class WordRecyclerFragment extends Fragment {
    ...
    public static final String DELETE_ALL = "com.example.roomwordssample.DELETE_ALL";
    ...
    public View onCreateView(
        ...
        getParentFragmentManager().setFragmentResultListener(NewWordFragment.RESULT_OK, this, (requestKey, result) -> {
            getParentFragmentManager().beginTransaction()
                    ...
                    .commit();
            Word word = new Word(0, result.getString(NewWordFragment.EXTRA_REPLY));
        ...
        getParentFragmentManager().setFragmentResultListener(DELETE_ALL, this, (requestKey, result) -> {
